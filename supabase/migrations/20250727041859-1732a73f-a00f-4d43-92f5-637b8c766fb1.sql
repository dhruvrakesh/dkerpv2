-- Phase 2B: Complete Material Flow Implementation (Essential Functions Only)
...
-- Priority 2: Build Essential Functions

-- Function 1: Detect Material Shortages
...
-- Function 2: Validate Material Balance
...
-- Priority 3: Sample Data Population (Stage Material Inputs Only)
...
SELECT DISTINCT
  ...
  bc.quantity_per_unit * o.order_quantity AS actual_qty,
...
-- Add sample stage material outputs for completed workflows
