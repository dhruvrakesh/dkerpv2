-- Phase 2B: Complete Material Flow Implementation (Corrected Input Types)
...
-- Using correct input_type values: 'substrate_carryforward', 'fresh_material', 'bom_component'
