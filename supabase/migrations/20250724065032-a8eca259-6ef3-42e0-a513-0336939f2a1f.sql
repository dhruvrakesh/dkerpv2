...
BEGIN
    ...
    IF raw_adhesive_item_exists AND raw_film_item_exists AND pkg_core_item_exists THEN
        ...
        -- March 2025 GRNs
        (dkegl_org_id, 'RAW_ADHESIVE_001', 'GRN-2025-001', '2025-03-01', 25.0, 500.00, 12500.00, 'KG', 'Adhesive Suppliers Ltd', 'INV-2025-001', '2025-03-01', 'approved', 'First batch of the month'),
        (dkegl_org_id, 'RAW_FILM_001', 'GRN-2025-002', '2025-03-02', 100.0, 150.00, 15000.00, 'SQM', 'Film Industries Pvt Ltd', 'INV-2025-002', '2025-03-02', 'approved', 'Quality grade A'),
        (dkegl_org_id, 'PKG_CORE_001', 'GRN-2025-003', '2025-03-05', 50, 50.00, 2500.00, 'PCS', 'Core Manufacturing Co', 'INV-2025-003', '2025-03-05', 'approved', 'Standard packaging cores'),
        
        -- April 2025 GRNs
        (dkegl_org_id, 'RAW_ADHESIVE_001', 'GRN-2025-004', '2025-04-01', 30.0, 500.00, 15000.00, 'KG', 'Adhesive Suppliers Ltd', 'INV-2025-004', '2025-04-01', 'approved', 'Regular monthly order'),
        (dkegl_org_id, 'RAW_FILM_001', 'GRN-2025-005', '2025-04-03', 150.0, 150.00, 22500.00, 'SQM', 'Film Industries Pvt Ltd', 'INV-2025-005', '2025-04-03', 'approved', 'Increased order for production'),
        (dkegl_org_id, 'PKG_CORE_001', 'GRN-2025-006', '2025-04-05', 75, 50.00, 3750.00, 'PCS', 'Core Manufacturing Co', 'INV-2025-006', '2025-04-05', 'approved', 'Bulk order for quarter'),
        
        -- Recent GRNs (Current month)
        (dkegl_org_id, 'RAW_ADHESIVE_001', 'GRN-2025-007', CURRENT_DATE - INTERVAL '15 days', 20.0, 510.00, 10200.00, 'KG', 'Adhesive Suppliers Ltd', 'INV-2025-007', CURRENT_DATE - INTERVAL '15 days', 'approved', 'Regular supply'),
        (dkegl_org_id, 'RAW_FILM_001', 'GRN-2025-008', CURRENT_DATE - INTERVAL '10 days', 80.0, 150.00, 12000.00, 'SQM', 'Film Industries Pvt Ltd', 'INV-2025-008', CURRENT_DATE - INTERVAL '10 days', 'approved', 'Production requirement'),
        (dkegl_org_id, 'PKG_CORE_001', 'GRN-2025-009', CURRENT_DATE - INTERVAL '5 days', 40, 50.00, 2000.00, 'PCS', 'Core Manufacturing Co', 'INV-2025-009', CURRENT_DATE - INTERVAL '5 days', 'pending', 'Quality check pending');
        ...
        RAISE NOTICE 'Sample data added successfully and stock summary refreshed';
