-- Fix the column reference in dkpkl_get_dashboard_metrics function
-- Change from 'posting_status' to 'posted_to_erp' for dkpkl_raw_rows table
...
BEGIN
  ...
  -- Get record statistics - FIXED: use posted_to_erp instead of posting_status
  SELECT 
    COUNT(*),
