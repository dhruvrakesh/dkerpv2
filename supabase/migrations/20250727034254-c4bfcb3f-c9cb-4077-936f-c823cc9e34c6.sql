-- Phase 2 Implementation: Complete Foundation & Material Flow Engine (Fixed)

-- Step 1: Add Missing Material Categories for 7 stages using correct column names
...
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 ...
 'substrate', 'primary', true, 1.0, 5.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Order Punching'), 
 'tooling', 'secondary', false, 0.1, 2.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Order Punching'), 
 'consumables', 'consumable', true, 0.05, 10.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Order Punching'), 
 'setup_materials', 'secondary', true, 0.02, 15.0, now()),

-- Gravure Printing categories  
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Gravure Printing'), 
 'substrate', 'primary', true, 1.0, 3.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Gravure Printing'), 
 'inks', 'secondary', true, 0.15, 8.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Gravure Printing'), 
 'solvents', 'secondary', true, 0.08, 12.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Gravure Printing'), 
 'plates', 'secondary', false, 0.001, 2.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Gravure Printing'), 
...
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 ...
 'substrate', 'primary', true, 1.0, 2.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Lamination Coating'), 
 'adhesives', 'secondary', true, 0.12, 5.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Lamination Coating'), 
 'primers', 'secondary', true, 0.05, 10.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Lamination Coating'), 
 'release_agents', 'consumable', true, 0.01, 25.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Lamination Coating'), 
 'catalysts', 'secondary', true, 0.02, 8.0, now()),
...
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Adhesive Coating'), 
 'specialized_adhesives', 'secondary', true, 0.18, 6.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Adhesive Coating'), 
 'activators', 'secondary', true, 0.03, 12.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Adhesive Coating'), 
 'coating_chemicals', 'consumable', true, 0.04, 15.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Adhesive Coating'), 
 'release_papers', 'secondary', true, 0.1, 8.0, now()),
...
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Coating'), 
 'coating_materials', 'secondary', true, 0.15, 7.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Coating'), 
 'solvents', 'secondary', true, 0.08, 18.0, now()),

-- Cylinder Preparation categories
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Cylinder Preparation'), 
 'cylinders', 'secondary', false, 0.1, 1.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Cylinder Preparation'), 
 'engraving_materials', 'consumable', true, 0.01, 30.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Cylinder Preparation'), 
 'chrome_plating', 'secondary', true, 0.02, 5.0, now()),
...
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Quality Assurance'), 
 'calibration_standards', 'secondary', false, 0.0001, 5.0, now()),
((SELECT id FROM dkegl_organizations WHERE code = 'DKEGL'), 
 (SELECT id FROM dkegl_workflow_stages WHERE stage_name = 'Quality Assurance'), 
