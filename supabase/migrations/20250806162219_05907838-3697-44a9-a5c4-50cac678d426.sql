-- Drop the audit trigger and function with cascade
DROP FUNCTION IF EXISTS dkegl_audit_opening_stock_changes() CASCADE;

-- Create simple opening stock data insertion
