-- Stock Summary System Activation - Simplified
DO $$
DECLARE
  org_id UUID;
  cat_pkg UUID;
...
BEGIN
  ...
  -- Create categories
  INSERT INTO dkegl_categories (organization_id, category_name, category_code, description, is_active) VALUES
  (org_id, 'Packaging Materials', 'PKG', 'Flexible packaging films', true),
  (org_id, 'Raw Materials', 'RAW', 'Production materials', true),
  (org_id, 'Consumables', 'CON', 'Supplies and consumables', true);
  ...
  (org_id, 'ISS24007', 'PKG_001', CURRENT_DATE - 25, 45, 'KG', 'Export Order'),
  (org_id, 'ISS24008', 'RAW_001', CURRENT_DATE - 35, 12, 'KG', 'Color Matching');
  ...
  RAISE NOTICE 'Stock Summary System FULLY ACTIVATED! Ready for analytics.';
END $$;