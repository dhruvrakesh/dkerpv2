-- Phase 1A: Fix BOM Structure & Stage Integration (Corrected)
...
WHERE component_item_code LIKE '%INK%' AND stage_id IS NULL;
...
WHERE component_item_code LIKE '%ADHESIVE%' AND stage_id IS NULL;
...
WHERE component_item_code LIKE '%COATING%' AND stage_id IS NULL;
