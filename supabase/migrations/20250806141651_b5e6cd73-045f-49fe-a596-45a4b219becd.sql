-- Fix SQL function with fully qualified column references to avoid ambiguity
...
-- 2. Create dkegl_get_comprehensive_stock_summary with qualified references
...
BEGIN
  ...
  WITH stock_summary AS (
    SELECT 
      ...
      COALESCE(cat.category_name, 'Uncategorized') as category_name_val,
