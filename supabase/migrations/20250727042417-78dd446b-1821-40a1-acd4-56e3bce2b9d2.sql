-- Fix function signature conflict and implement enhanced stock management

-- Drop existing function to fix conflict
DROP FUNCTION IF EXISTS dkegl_refresh_stock_summary(uuid);

-- Create enhanced stock summary refresh function with configurable opening date
