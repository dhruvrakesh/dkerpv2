...
DECLARE
  ...
  cat_con UUID;
BEGIN
  -- Get organization and category IDs
  ...
  RAISE NOTICE 'Stock Summary System ACTIVATED! 6 items, 6 GRN records, 6 issue records with full analytics.';
END $$;