-- Fix the stock snapshot function
...
-- Populate current stock summary
...
SELECT 
  ...
  s.current_qty - (s.opening_qty + COALESCE(grn.total_grn, 0) - COALESCE(iss.total_issued, 0)) as variance_qty,
