-- Final Stock Summary System Activation
DO $$
DECLARE
  org_id UUID;
...
BEGIN
  ...
  (org_id, 'PKG_001', 250, 180, 120), (org_id, 'PKG_002', 320, 225, 95), (org_id, 'PKG_003', 150, 85, 180), (org_id, 'PKG_004', 800, 650, 25),
  (org_id, 'RAW_001', 75, 45, 450), (org_id, 'RAW_002', 80, 52, 465), (org_id, 'RAW_003', 120, 95, 320), (org_id, 'RAW_004', 300, 180, 85),
  (org_id, 'CON_001', 15, 8, 2500), (org_id, 'CON_002', 35, 22, 180), (org_id, 'CON_003', 4, 2, 15000), (org_id, 'CON_004', 150, 85, 125)
  ...
  (org_id, 'GRN24002', 'PKG_002', CURRENT_DATE - 8, 150, 'KG', 14250, 'Polyplex Corporation'),
  (org_id, 'GRN24003', 'RAW_001', CURRENT_DATE - 12, 50, 'KG', 22500, 'Siegwerk India'),
  (org_id, 'GRN24004', 'RAW_004', CURRENT_DATE - 15, 200, 'LTR', 17000, 'Chemanol India'),
  (org_id, 'GRN24005', 'CON_002', CURRENT_DATE - 18, 25, 'PCS', 4500, 'Heidelberg Equipment'),
  (org_id, 'GRN23045', 'PKG_003', CURRENT_DATE - 45, 80, 'KG', 14400, 'Cosmo Films'),
  (org_id, 'GRN23046', 'RAW_003', CURRENT_DATE - 50, 75, 'KG', 24000, 'Covestro India'),
  (org_id, 'GRN23047', 'CON_001', CURRENT_DATE - 60, 10, 'PCS', 25000, 'Komori India'),
  (org_id, 'GRN23048', 'PKG_004', CURRENT_DATE - 70, 500, 'SQM', 12500, 'Jindal Poly Films'),
  (org_id, 'GRN23049', 'CON_004', CURRENT_DATE - 80, 100, 'LTR', 12500, 'Henkel Adhesives')
  ON CONFLICT (organization_id, grn_number, item_code) DO NOTHING;

  -- Insert Issue Logs with issue numbers
  INSERT INTO dkegl_issue_log (organization_id, issue_number, item_code, date, qty_issued, purpose) VALUES
  (org_id, 'ISS24001', 'PKG_001', CURRENT_DATE - 2, 25, 'Production Order PO-2024-001'),
  (org_id, 'ISS24002', 'PKG_002', CURRENT_DATE - 3, 35, 'Production Order PO-2024-002'),
  (org_id, 'ISS24003', 'RAW_001', CURRENT_DATE - 4, 8, 'Printing Job J-001'),
  (org_id, 'ISS24004', 'RAW_002', CURRENT_DATE - 5, 10, 'Printing Job J-002'),
  (org_id, 'ISS24005', 'CON_002', CURRENT_DATE - 6, 3, 'Machine Maintenance'),
  (org_id, 'ISS24006', 'PKG_003', CURRENT_DATE - 15, 45, 'Export Order EX-2024-001'),
  (org_id, 'ISS24007', 'RAW_003', CURRENT_DATE - 20, 15, 'Lamination Process'),
  (org_id, 'ISS24008', 'RAW_004', CURRENT_DATE - 25, 80, 'Cleaning & Maintenance'),
  (org_id, 'ISS24009', 'CON_001', CURRENT_DATE - 28, 2, 'Press Setup'),
  (org_id, 'ISS23050', 'PKG_001', CURRENT_DATE - 40, 45, 'Production Order PO-2023-089'),
  (org_id, 'ISS23051', 'PKG_002', CURRENT_DATE - 50, 60, 'Production Order PO-2023-090'),
  (org_id, 'ISS23052', 'RAW_001', CURRENT_DATE - 55, 12, 'Color Matching'),
  (org_id, 'ISS23053', 'CON_003', CURRENT_DATE - 65, 1, 'Quality Control'),
  (org_id, 'ISS23054', 'CON_004', CURRENT_DATE - 75, 40, 'Equipment Cleaning')
  ON CONFLICT (organization_id, issue_number, item_code) DO NOTHING;
  ...
  RAISE NOTICE 'Stock Summary System ACTIVATED! 12 items, 10 GRN records, 14 issue records, analytics generated';
END $$;