...
export function AIChatInterface({ contextType = 'general', contextData = {}, className }: AIChatInterfaceProps) {
  ...
  const getContextBadge = () => {
    const contextMap = {
      ...
      inventory: { label: 'Inventory', variant: 'secondary' as const },
      manufacturing: { label: 'Manufacturing', variant: 'outline' as const },
      analytics: { label: 'Analytics', variant: 'destructive' as const },
    };

    const context = contextMap[contextType as keyof typeof contextMap] || contextMap.general;
          ...
          <div className="space-y-4">
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-32 text-muted-foreground">
                ...
                <p className="text-sm">Ask about inventory, manufacturing, or analytics</p>
              </div>
            )}
